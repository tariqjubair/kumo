                                        ...
                                        <div class="perm_item">
                                            <div class="timeline-panel head-chk mb-2 bg-primary group_chk">
                                                <div class="custom-control custom-checkbox checkbox-success check-lg mr-3">
                                                    <input type="checkbox" class="custom-control-input group" id="group{{$group->id}}" required="" name="group_id" value="{{$group->id}}" disabled="disabled">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="timeline-panel mb-1">
                                                            <div class="custom-control custom-checkbox checkbox-primary check-lg mr-3">
                                                                <input type="checkbox" class="custom-control-input perm" id="perm{{$perm->id}}" required="" name="perm_id" value="{{$perm->id}}">
