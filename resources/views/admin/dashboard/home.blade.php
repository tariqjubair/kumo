...
<div class="page-titles">
    <ol class="breadcrumb">
        <li class="breadcrumb-item active"><a href="javascript:void(0)">Target Sales: Last 7 Days</a></li>
    </ol>
</div>
<div class="row">
            ...
            <div class="card-body">
                <div class="media align-items-center">
                    <span class="activity-icon bgl-primary mr-md-4 mr-3">
                        <img src="{{asset('dashboard/images/dash_order.png')}}" alt="Orders" width="50%">
                    </span>
                    <div class="media-body">
                        <p class="fs-14 mb-2">Todays Orders</p>
                        <span class="title text-black font-w600">42%</span>
                    </div>
                </div>
                <div class="progress" style="height:5px;">
            ...
            <div class="card-body">
                <div class="media align-items-center">
                    <span class="activity-icon bgl-info  mr-md-4 mr-3">
                        <img src="{{asset('dashboard/images/dash-sales.png')}}" alt="Orders" width="50%">
                    </span>
                    <div class="media-body">
                ...
                <div class="progress" style="height:5px;">
                    <div class="progress-bar bg-info" style="width: 82%; height:5px;" role="progressbar">
                        <span class="sr-only">42% Complete</span>
                    </div>
                </div>
            </div>
    ...
    <div class="col-sm-6 col-xl-3">
        <div class="card avtivity-card">
            <div class="card-body">
                <div class="media align-items-center">
                    <span class="activity-icon bgl-secondary mr-md-4 mr-3">
                        <img src="{{asset('dashboard/images/dash-visitor.png')}}" alt="Orders" width="50%">
                    </span>
                    <div class="media-body">
                        <p class="fs-14 mb-2">Todays Visitors</p>
                        <span class="title text-black font-w600">250</span>
                    </div>
                </div>
                <div class="progress" style="height:5px;">
                    <div class="progress-bar bg-secondary" style="width: 90%; height:5px;" role="progressbar">
                        <span class="sr-only">42% Complete</span>
                    </div>
                </div>
            </div>
    ...
    <div class="col-sm-6 col-xl-3">
        <div class="card avtivity-card">
            <div class="card-body">
                <div class="media align-items-center">
                    <span class="activity-icon bgl-success  mr-md-4 mr-3">
                        <img src="{{asset('dashboard/images/dash-delivery.png')}}" alt="Orders" width="60%">
                    </span>
                    <div class="media-body">
                        <p class="fs-14 mb-2">Todays Delivery</p>
                        <span class="title text-black font-w600">15</span>
                    </div>
                </div>
                <div class="progress" style="height:5px;">
        ...
        <div class="widget-stat card" style="background: rgb(255, 108, 10)">
            <div class="card-body p-4">
                <div class="media">
                    ...
                    <div class="media-body text-white text-right">
                        <p class="mb-1">Todays Sales</p>
                        <h3 class="text-white">1,20,000</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="widget-stat card bg-success">
            <div class="card-body p-4">
                <div class="media">
                    ...
                    <div class="media-body text-white text-right">
                        <p class="mb-1">Orders Confirmed in {{Carbon\carbon::now()->format('M')}}</p>
                        <h3 class="text-white">23</h3>
                    </div>
                </div>
            </div>
        ...
        <div class="widget-stat card bg-primary">
            <div class="card-body p-4">
                <div class="media">
                    ...
                    <div class="media-body text-white text-right">
                        <p class="mb-1">Orders Delivered in {{Carbon\carbon::now()->format('M')}}</p>
                        <h3 class="text-white">23</h3>
                    </div>
                </div>
            </div>
        ...
        <div class="widget-stat card bg-warning">
            <div class="card-body p-4">
                <div class="media">
                    ...
                    <div class="media-body text-white text-right">
                        <p class="mb-1">Waiting Orders for Week</p>
                        <h3 class="text-white">23</h3>
                    </div>
                </div>
            </div>
        ...
        <div class="widget-stat card bg-danger">
            <div class="card-body p-4">
                <div class="media">
                    ...
                    <div class="media-body text-white text-right">
                        <p class="mb-1">Orders Cancelled in {{Carbon\carbon::now()->format('M')}}</p>
                        <h3 class="text-white">23</h3>
                    </div>
                </div>
            </div>
